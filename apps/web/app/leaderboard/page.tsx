 ...
 * /leaderboard — T-604
 *
 * Lifetime aggregate leaderboard over claims A–D.
 * - Interleaved human + AI rows in one ranked table.
 * - Accuracy % excludes abstentions from denominator (PRD §6.6).
 * - Sortable columns.
 * - Responsive ≤380px.
 * - Plugboard gets "EXTERNAL RUNTIME" badge (not AI, not HUMAN — external).
 * - Mono for numeric cells, DESIGN.md tokens for layout/color.
 */
...
export default function LeaderboardPage() {
  const initialRows = getLeaderboard();
