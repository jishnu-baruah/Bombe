 ...
 * payment it POSTs /api/v1/request, which verifies the payment and (when the live
 * post path is enabled) posts + attests and returns the claim id. Posting is
 * operator-side because postClaim is OPERATOR_ROLE-gated (D18); funds are never held.
 */
  ...
  async function connect() {
    ...
    try {
      ...
      try {
        ...
        // chain not added / switch declined; payment still validates the chain
      }
